...
public class organizer_profile_setting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organizer_profile_setting);
        ...
        btnsec.setOnClickListener(v -> startActivity(new Intent(this, organizer_security.class)));
        ...
        if (auth.getCurrentUser() != null) {
            ...
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(organizer_profile_setting.this, "Failed to load profile", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    private void updateProfilePic(String picValue) {
        if (auth.getCurrentUser() != null) {
            ...
            userRef.child("profilePic").setValue(picValue)
                    ...
                    .addOnFailureListener(e -> Toast.makeText(this, "Failed to update database", Toast.LENGTH_SHORT).show());
        }
    }
}
